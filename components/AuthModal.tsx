...
export default function AuthModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/75 p-4 text-white backdrop-blur-md">
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-white/10 bg-[#070a12] shadow-2xl lg:grid-cols-[0.92fr_1.08fr]">
        <div className="relative hidden min-h-[620px] overflow-hidden bg-gradient-to-br from-blue-950 via-slate-950 to-purple-950 p-8 lg:block">
