...
const backup = target + ".bak_flags_variables";
...
const replacements = [
  ...
  {
    "old": "        setSelectedNodeId(projectData.startNodeId ?? projectData.nodes?.[0]?.id ?? null);\n",
    "new": "        setSelectedNodeId(projectData.startNodeId ?? projectData.nodes?.[0]?.id ?? null);\n        setStoryVariables(\n          Array.isArray(projectData.variables) ? projectData.variables : [],\n        );\n",
