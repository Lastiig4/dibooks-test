-- DiBooks - Switch automatic node moderation to DeepSeek
-- Uitvoeren NA Moderation Core v1.
-- Mag veilig worden uitgevoerd als de OpenAI AI Node Moderation SQL al is uitgevoerd.
...
begin
  ...
  -- Een nieuwe DeepSeek-scan vervangt eerdere AUTOMATISCHE AI-flags.
  -- Handmatige/adminflags blijven onaangetast.
    ...
    values (
      ...
      left(
        coalesce(
          ...
          'Automatische scan vraagt om menselijke controle.'
        ),
        1200
      ),
      'deepseek'
